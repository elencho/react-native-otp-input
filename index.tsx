        ...
        return (
            <View pointerEvents="none" key={index + "view"} testID="inputSlotView">
                <TextInput
                    ...
                    style={selectedIndex === index ? [defaultTextFieldStyle, codeInputFieldStyle, ] : digits.length  > index   ? codeInputHighlightStyle :[defaultTextFieldStyle, codeInputFieldStyle,]}                    ref={ref => { this.fields[index] = ref }}
                    onChangeText={text => {
